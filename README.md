...
-Default renderer is now OpenGL, as some modern hardware has issues with DX9
...
# Maybes
-Encounter randomizer? (Requires re-writing how maps and events are handled, might not do it)
...
-Unique boss music? (using 音屋のばけばけ カタルシス少年戯樂団's PC98 sequences)
